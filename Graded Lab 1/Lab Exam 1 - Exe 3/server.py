...
class Server():
    """ Server implements a one-salt-character recovery game challenger.

    The challenger interacts with an adversary, and reveals a flag to the
    adversary if they show a significant advantage in the one-salt-character recovery game.
    ...
    def guess_loop(self):
        """ Single one-salt-character game recovery round: read messages from the
        adversary.
        ...
        Returns:
            bool: true if the adversary correctly guessed the last character of the salt.
        """
        msg = None
...
if __name__ == "__main__":
    ...
    # Start the server and point your client to "localhost:50402" to connect to it.
    ...
    TCPServer(("localhost", 50402), LocalRequestHandler).serve_forever()
