...
class Server():
    ...
    def exec_command(self, command: str):
        ...
        """
        if command == "flag_hey_there_oh_noes_block_boundaries_rip":
...
if __name__ == "__main__":
    ...
    # Start the server and point your client to "localhost:50406" to connect to it.
    ...
    TCPServer(("localhost", 50406), LocalRequestHandler).serve_forever()
