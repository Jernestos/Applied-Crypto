...
class Server():
    ...
    def read_command(self, msg: bytes, encrypted : bool = True) -> str:
        ...
        """
        command = msg["command"]
        print("read_command encrypted: command: ", end="")
        print(command)
        if encrypted:
        ...
        print("read_command decrypted: command: ", end="")
        print(command)
        return command
    ...
    def exec_command(self, command: str):
        ...
        print("exec_command: command: ", end="")
        print(command)
        if command == "flag":
            return "Here's your flag: " + self.flag
        else:
...
if __name__ == "__main__":
    ...
    # Start the server and point your client to "localhost:50405" to connect to it.
    ...
    TCPServer(("localhost", 50405), LocalRequestHandler).serve_forever()
